...
<form id="forms_ajout_photos" enctype="multipart/form-data">
            ...
            <div class="form-group form-show-validation row">
                ...
                <div class="col-lg-7 col-md-9 col-sm-8">
                    <div class="input-file input-file-image">
                        ...
                        <input type="file" class="form-control form-control-file" id="img_etudiant" name="img_etudiant" accept="image/*" required >
                        <label for="img_etudiant" class="btn btn-primary btn-round btn-sm"><i class="fa fa-file-image"></i> Choisir image</label>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-sm btn-success" id="ajout_photo_etudiant"><i class="fas fa-save mr-2"></i> Ajouter</button>
    </div>
</form>
