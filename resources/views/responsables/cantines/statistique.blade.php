...
<div class="align-items-left align-items-md-center pt-3 pb-4">
	<div>
		<h2 class="pb-2 fw-bold"><i class="fas fa-dollar-sign"></i>&nbsp;&nbsp; Détails des paiements de la cantine scolaire</h2>
	</div>
    <hr>
</div>
<div class="row mx-3">
                ...
                <div class="row align-items-center px-3">
                    ...
                    <div class="col col-stats ml-3 ml-sm-0">
                        <div class="numbers w-100 text-right">
                            <p class="card-category">PAIEMENT JOURNALIERE</p>
        ...
        <div class="card card-stats card-round">
            <div class="card-body">
                <div class="row align-items-center px-3">
                    ...
                    <div class="col col-stats ml-3 ml-sm-0">
                        <div class="numbers w-100 text-right">
                            <p class="card-category">PAIEMENT HEBDOMADAIRE</p>
                            <h4 class="card-title">{{nombre_format($totaSem)}} AR</h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center px-3">
                    ...
                    <div class="col col-stats ml-3 ml-sm-0">
                        <div class="numbers w-100 text-right">
                            ...
                            <h4 class="card-title">{{nombre_format($totalMois)}} AR</h4>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="row my-2 mx-3">
    <div class="alert alert-info alert-dismissible w-100" role="alert">
        <strong>Pour afficher les détails de la cantine payée, vous devez choisir les dates et la classe des élèves</strong>
...
<div class="row my-2 mx-3">
    ...
    <div class="col-md-2">
        <div class="form-group">
            <button class="btn btn-success mt-4 btn-block" id="affiche_det" >Afficher les détails</button>
        </div>
    </div>
</div>
<div class="row my-2 mx-3" id="liste_details_cantine">
