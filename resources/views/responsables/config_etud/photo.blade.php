<div class="modal-header">
    <h5 class="modal-title fw-bold" id="modalAppTitle">Modifier la photo d'étudiant</h5>
...
<form id="form-ajout-photo" enctype="multipart/form-data">
            ...
            <div class="form-group form-show-validation row">
                ...
                <div class="col-lg-7 col-md-9 col-sm-8">
                    <div class="input-file input-file-image">
                        ...
                        <input type="file" class="form-control form-control-file" id="img_etud" name="img_etud" accept="image/*" required >
                        <label for="img_etud" class="btn btn-primary btn-round btn-sm"><i class="fa fa-file-image"></i> Choisir image</label>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-sm btn-success" id="ajout_photo_etud"><i class="fas fa-save mr-2"></i> Ajouter</button>
    </div>
</form>
