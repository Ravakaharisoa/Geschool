...
@section('contents')
    ...
    <div class="row m-1">
        <a href="{{route('resp.etudiant.imprimer_details_etudiant',$eleve->id)}}" class="btn m-1 btn-primary">Imprimer</a>
        <button id="{{$eleve->id}}" class="btn m-1 btn-danger change-photo">Nouvelle photo</button>
        <button id="{{$eleve->id}}" class="btn m-1 btn-success update_info">Modifier les infos</button>
        <button id="{{$eleve->id}}" class="btn m-1 btn-warning paye_scolarite">Payer la scolarité</button>
        <button id="{{$eleve->id}}" class="btn m-1 btn-secondary payer_cantine">Payer la cantine</button>
        <button id="{{$eleve->id}}" class="btn m-1 btn-danger payer_transport">Payer le transport</button>
        <a href="{{route('resp.etudiant.bulletin_etud',$eleve->id)}}" class="btn m-1 btn-info">Bulletin</a>
        <button id="{{$eleve->id}}" class="btn m-1 btn-success">Envoi SMS</button>
        <button id="{{$eleve->id}}" class="btn m-1 btn-warning">Envoi Email</button>
